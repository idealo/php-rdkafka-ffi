...
const RD_KAFKA_SUPPORTED_METHODS = [
    ...
    'rd_kafka_error_code' => 'rd_kafka_error_code',
    'rd_kafka_error_name' => 'rd_kafka_error_name',
    'rd_kafka_error_string' => 'rd_kafka_error_string',
    'rd_kafka_error_is_fatal' => 'rd_kafka_error_is_fatal',
    'rd_kafka_error_is_retriable' => 'rd_kafka_error_is_retriable',
    'rd_kafka_error_txn_requires_abort' => 'rd_kafka_error_txn_requires_abort',
    'rd_kafka_error_destroy' => 'rd_kafka_error_destroy',
    'rd_kafka_error_new' => 'rd_kafka_error_new',
    ...
    'rd_kafka_conf_set_oauthbearer_token_refresh_cb' => 'rd_kafka_conf_set_oauthbearer_token_refresh_cb',
    ...
    'rd_kafka_conf_set_ssl_cert_verify_cb' => 'rd_kafka_conf_set_ssl_cert_verify_cb',
    'rd_kafka_conf_set_ssl_cert' => 'rd_kafka_conf_set_ssl_cert',
    ...
    'rd_kafka_msg_partitioner_fnv1a' => 'rd_kafka_msg_partitioner_fnv1a',
    'rd_kafka_msg_partitioner_fnv1a_random' => 'rd_kafka_msg_partitioner_fnv1a_random',
    ...
    'rd_kafka_consumer_group_metadata' => 'rd_kafka_consumer_group_metadata',
    'rd_kafka_consumer_group_metadata_new' => 'rd_kafka_consumer_group_metadata_new',
    'rd_kafka_consumer_group_metadata_destroy' => 'rd_kafka_consumer_group_metadata_destroy',
    'rd_kafka_consumer_group_metadata_write' => 'rd_kafka_consumer_group_metadata_write',
    'rd_kafka_consumer_group_metadata_read' => 'rd_kafka_consumer_group_metadata_read',
    ...
    'rd_kafka_event_config_string' => 'rd_kafka_event_config_string',
    ...
    'rd_kafka_oauthbearer_set_token' => 'rd_kafka_oauthbearer_set_token',
    'rd_kafka_oauthbearer_set_token_failure' => 'rd_kafka_oauthbearer_set_token_failure',
    'rd_kafka_init_transactions' => 'rd_kafka_init_transactions',
    'rd_kafka_begin_transaction' => 'rd_kafka_begin_transaction',
    'rd_kafka_send_offsets_to_transaction' => 'rd_kafka_send_offsets_to_transaction',
    'rd_kafka_commit_transaction' => 'rd_kafka_commit_transaction',
    'rd_kafka_abort_transaction' => 'rd_kafka_abort_transaction',
];
...
rd_kafka_resp_err_t rd_kafka_error_code(rd_kafka_error_t *error);
char * rd_kafka_error_name(rd_kafka_error_t *error);
char * rd_kafka_error_string(rd_kafka_error_t *error);
int rd_kafka_error_is_fatal(rd_kafka_error_t *error);
int rd_kafka_error_is_retriable(rd_kafka_error_t *error);
int rd_kafka_error_txn_requires_abort(rd_kafka_error_t *error);
void rd_kafka_error_destroy(rd_kafka_error_t *error);
rd_kafka_error_t * rd_kafka_error_new(rd_kafka_resp_err_t code, char *fmt, ...);
...
void rd_kafka_topic_partition_list_sort(rd_kafka_topic_partition_list_t *rktparlist, int(*cmp)(void *a, void *b, void *cmp_opaque), void *cmp_opaque);
...
rd_kafka_conf_t * rd_kafka_conf(rd_kafka_t *rk);
...
void rd_kafka_conf_set_oauthbearer_token_refresh_cb(rd_kafka_conf_t *conf, void(*oauthbearer_token_refresh_cb)(rd_kafka_t *rk, char *oauthbearer_config, void *opaque));
...
rd_kafka_conf_res_t rd_kafka_conf_set_ssl_cert_verify_cb(rd_kafka_conf_t *conf, int(*ssl_cert_verify_cb)(rd_kafka_t *rk, char *broker_name, int32_t broker_id, int *x509_error, int depth, char *buf, size_t size, char *errstr, size_t errstr_size, void *opaque));
...
rd_kafka_conf_res_t rd_kafka_conf_set_ssl_cert(rd_kafka_conf_t *conf, rd_kafka_cert_type_t cert_type, rd_kafka_cert_enc_t cert_enc, void *buffer, size_t size, char *errstr, size_t errstr_size);
...
int32_t rd_kafka_msg_partitioner_random(rd_kafka_topic_t *rkt, void *key, size_t keylen, int32_t partition_cnt, void *rkt_opaque, void *msg_opaque);
int32_t rd_kafka_msg_partitioner_consistent(rd_kafka_topic_t *rkt, void *key, size_t keylen, int32_t partition_cnt, void *rkt_opaque, void *msg_opaque);
int32_t rd_kafka_msg_partitioner_consistent_random(rd_kafka_topic_t *rkt, void *key, size_t keylen, int32_t partition_cnt, void *rkt_opaque, void *msg_opaque);
...
int32_t rd_kafka_msg_partitioner_fnv1a(rd_kafka_topic_t *rkt, void *key, size_t keylen, int32_t partition_cnt, void *rkt_opaque, void *msg_opaque);
int32_t rd_kafka_msg_partitioner_fnv1a_random(rd_kafka_topic_t *rkt, void *key, size_t keylen, int32_t partition_cnt, void *rkt_opaque, void *msg_opaque);
...
rd_kafka_resp_err_t rd_kafka_commit_queue(rd_kafka_t *rk, rd_kafka_topic_partition_list_t *offsets, rd_kafka_queue_t *rkqu, void(*cb)(rd_kafka_t *rk, rd_kafka_resp_err_t err, rd_kafka_topic_partition_list_t *offsets, void *commit_opaque), void *commit_opaque);
...
rd_kafka_consumer_group_metadata_t * rd_kafka_consumer_group_metadata_new(char *group_id);
void rd_kafka_consumer_group_metadata_destroy(rd_kafka_consumer_group_metadata_t *);
rd_kafka_error_t * rd_kafka_consumer_group_metadata_write(rd_kafka_consumer_group_metadata_t *cgmd, void **bufferp, size_t *sizep);
rd_kafka_error_t * rd_kafka_consumer_group_metadata_read(rd_kafka_consumer_group_metadata_t **cgmdp, void *buffer, size_t size);
...
char * rd_kafka_event_config_string(rd_kafka_event_t *rkev);
...
rd_kafka_resp_err_t rd_kafka_oauthbearer_set_token(rd_kafka_t *rk, char *token_value, int64_t md_lifetime_ms, char *md_principal_name, char **extensions, size_t extension_size, char *errstr, size_t errstr_size);
rd_kafka_resp_err_t rd_kafka_oauthbearer_set_token_failure(rd_kafka_t *rk, char *errstr);
...
rd_kafka_error_t * rd_kafka_send_offsets_to_transaction(rd_kafka_t *rk, rd_kafka_topic_partition_list_t *offsets, rd_kafka_consumer_group_metadata_t *cgmetadata, int timeout_ms);

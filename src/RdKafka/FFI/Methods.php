...
trait Methods
{
     ...
     */
    public static function rd_kafka_get_err_descs(?CData $errdescs, ?CData $cntp)
    {
     ...
     */
    public static function rd_kafka_topic_partition_destroy(?CData $rktpar)
    {
     ...
     */
    public static function rd_kafka_topic_partition_list_destroy(?CData $rkparlist)
    {
     ...
     */
    public static function rd_kafka_topic_partition_list_add_range(?CData $rktparlist, ?string $topic, ?int $start, ?int $stop)
    {
     ...
     */
    public static function rd_kafka_topic_partition_list_sort(?CData $rktparlist, ?callable $cmp, $opaque)
    {
     ...
     */
    public static function rd_kafka_headers_destroy(?CData $hdrs)
    {
     ...
     */
    public static function rd_kafka_message_destroy(?CData $rkmessage)
    {
     ...
     * @param CData|null $hdrs rd_kafka_headers_t_ptr
     */
    public static function rd_kafka_message_set_headers(?CData $rkmessage, ?CData $hdrs)
    {
     ...
     */
    public static function rd_kafka_conf_destroy(?CData $conf)
    {
     ...
     */
    public static function rd_kafka_conf_set_events(?CData $conf, ?int $events)
    {
     ...
     */
    public static function rd_kafka_conf_set_background_event_cb(?CData $conf, ?callable $event_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_dr_cb(?CData $conf, ?callable $dr_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_dr_msg_cb(?CData $conf, ?callable $dr_msg_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_consume_cb(?CData $conf, ?callable $consume_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_rebalance_cb(?CData $conf, ?callable $rebalance_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_offset_commit_cb(?CData $conf, ?callable $offset_commit_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_error_cb(?CData $conf, ?callable $error_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_throttle_cb(?CData $conf, ?callable $throttle_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_log_cb(?CData $conf, ?callable $log_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_stats_cb(?CData $conf, ?callable $stats_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_socket_cb(?CData $conf, ?callable $socket_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_connect_cb(?CData $conf, ?callable $connect_cb)
    {
     ...
     */
    public static function rd_kafka_conf_set_closesocket_cb(?CData $conf, ?callable $closesocket_cb)
    {
     ...
     * @param CData|string|null $opaque void_ptr
     */
    public static function rd_kafka_conf_set_opaque(?CData $conf, $opaque)
    {
     ...
     */
    public static function rd_kafka_conf_set_default_topic_conf(?CData $conf, ?CData $tconf)
    {
     ...
     */
    public static function rd_kafka_conf_dump_free(?CData $arr, ?int $cnt)
    {
     ...
     */
    public static function rd_kafka_conf_properties_show(?CData $fp)
    {
     ...
     */
    public static function rd_kafka_topic_conf_destroy(?CData $topic_conf)
    {
     ...
     * @param CData|string|null $opaque void_ptr
     */
    public static function rd_kafka_topic_conf_set_opaque(?CData $conf, $opaque)
    {
     ...
     */
    public static function rd_kafka_topic_conf_set_partitioner_cb(?CData $topic_conf, ?callable $partitioner)
    {
     ...
     */
    public static function rd_kafka_topic_conf_set_msg_order_cmp(?CData $topic_conf, ?callable $msg_order_cmp)
    {
     ...
     * @param CData|null $rk rd_kafka_t_ptr
     */
    public static function rd_kafka_destroy(?CData $rk)
    {
     ...
     */
    public static function rd_kafka_destroy_flags(?CData $rk, ?int $flags)
    {
     ...
     * @param CData|null $rkt rd_kafka_topic_t_ptr
     */
    public static function rd_kafka_topic_destroy(?CData $rkt)
    {
     ...
     * @param CData|null $rk rd_kafka_t_ptr
     */
    public static function rd_kafka_yield(?CData $rk)
    {
     ...
     */
    public static function rd_kafka_mem_free(?CData $rk, $ptr)
    {
     ...
     */
    public static function rd_kafka_queue_destroy(?CData $rkqu)
    {
     ...
     */
    public static function rd_kafka_queue_forward(?CData $src, ?CData $dst)
    {
     ...
     * @param int|null $size int
     */
    public static function rd_kafka_queue_io_event_enable(?CData $rkqu, ?int $fd, $payload, ?int $size)
    {
     ...
     * @param CData|string|null $opaque void_ptr
     */
    public static function rd_kafka_queue_cb_event_enable(?CData $rkqu, ?callable $event_cb, $opaque)
    {
     ...
     */
    public static function rd_kafka_metadata_destroy(?CData $metadata)
    {
     ...
     */
    public static function rd_kafka_group_list_destroy(?CData $grplist)
    {
     ...
     */
    public static function rd_kafka_set_logger(?CData $rk, ?callable $func)
    {
     ...
     */
    public static function rd_kafka_set_log_level(?CData $rk, ?int $level)
    {
     ...
     */
    public static function rd_kafka_log_print(?CData $rk, ?int $level, ?string $fac, ?string $buf)
    {
     ...
     * @param CData|null $rk rd_kafka_t_ptr
     */
    public static function rd_kafka_dump(?CData $fp, ?CData $rk)
    {
     ...
     * @param CData|null $rkev rd_kafka_event_t_ptr
     */
    public static function rd_kafka_event_destroy(?CData $rkev)
    {
     ...
     */
    public static function rd_kafka_AdminOptions_destroy(?CData $options)
    {
     ...
     * @param CData|string|null $opaque void_ptr
     */
    public static function rd_kafka_AdminOptions_set_opaque(?CData $options, $opaque)
    {
     ...
     */
    public static function rd_kafka_NewTopic_destroy(?CData $new_topic)
    {
     ...
     */
    public static function rd_kafka_NewTopic_destroy_array(?CData $new_topics, ?int $new_topic_cnt)
    {
     ...
     * @param CData|null $rkqu rd_kafka_queue_t_ptr
     */
    public static function rd_kafka_CreateTopics(?CData $rk, ?CData $new_topics, ?int $new_topic_cnt, ?CData $options, ?CData $rkqu)
    {
     ...
     */
    public static function rd_kafka_DeleteTopic_destroy(?CData $del_topic)
    {
     ...
     */
    public static function rd_kafka_DeleteTopic_destroy_array(?CData $del_topics, ?int $del_topic_cnt)
    {
     ...
     * @param CData|null $rkqu rd_kafka_queue_t_ptr
     */
    public static function rd_kafka_DeleteTopics(?CData $rk, ?CData $del_topics, ?int $del_topic_cnt, ?CData $options, ?CData $rkqu)
    {
     ...
     */
    public static function rd_kafka_NewPartitions_destroy(?CData $new_parts)
    {
     ...
     */
    public static function rd_kafka_NewPartitions_destroy_array(?CData $new_parts, ?int $new_parts_cnt)
    {
     ...
     * @param CData|null $rkqu rd_kafka_queue_t_ptr
     */
    public static function rd_kafka_CreatePartitions(?CData $rk, ?CData $new_parts, ?int $new_parts_cnt, ?CData $options, ?CData $rkqu)
    {
     ...
     */
    public static function rd_kafka_ConfigResource_destroy(?CData $config)
    {
     ...
     */
    public static function rd_kafka_ConfigResource_destroy_array(?CData $config, ?int $config_cnt)
    {
     ...
     * @param CData|null $rkqu rd_kafka_queue_t_ptr
     */
    public static function rd_kafka_AlterConfigs(?CData $rk, ?CData $configs, ?int $config_cnt, ?CData $options, ?CData $rkqu)
    {
     ...
     * @param CData|null $rkqu rd_kafka_queue_t_ptr
     */
    public static function rd_kafka_DescribeConfigs(?CData $rk, ?CData $configs, ?int $config_cnt, ?CData $options, ?CData $rkqu)
    {
     ...
     */
    public static function rd_kafka_conf_set_oauthbearer_token_refresh_cb(?CData $conf, ?callable $oauthbearer_token_refresh_cb)
    {
     ...
     * @param CData|null $error rd_kafka_error_t_ptr
     */
    public static function rd_kafka_error_destroy(?CData $error)
    {
     ...
     */
    public static function rd_kafka_consumer_group_metadata_destroy(?CData $rd_kafka_consumer_group_metadata_t_ptr)
    {

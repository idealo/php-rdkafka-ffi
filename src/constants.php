...
// since librdkafka v1.0.0
const RD_KAFKA_PARTITION_UA = -1;
const RD_KAFKA_DESTROY_F_NO_CONSUMER_CLOSE = 0x8;
...
const RD_KAFKA_EVENT_NONE = 0x0;
const RD_KAFKA_EVENT_DR = 0x1;
const RD_KAFKA_EVENT_FETCH = 0x2;
const RD_KAFKA_EVENT_LOG = 0x4;
const RD_KAFKA_EVENT_ERROR = 0x8;
...
const RD_KAFKA_RESP_ERR_UNSUPPORTED_COMPRESSION_TYPE_V100 = 74; // ^1.0.1 = 76
const RD_KAFKA_RESP_ERR_END_ALL_V100 = 75; // ^1.0.1 = 82
...
// since librdkafka v1.0.1
const RD_KAFKA_RESP_ERR_FENCED_LEADER_EPOCH = 74;
const RD_KAFKA_RESP_ERR_UNKNOWN_LEADER_EPOCH = 75;
const RD_KAFKA_RESP_ERR_UNSUPPORTED_COMPRESSION_TYPE = 76; // use RD_KAFKA_RESP_ERR_UNSUPPORTED_COMPRESSION_TYPE_V100 with librdkafka version 1.0.0
...
const RD_KAFKA_RESP_ERR_END_ALL = 82; // use RD_KAFKA_RESP_ERR_END_ALL_V100 with librdkafka version 1.0.0

// since librdkafka v1.1.0
const RD_KAFKA_EVENT_OAUTHBEARER_TOKEN_REFRESH = 0x100;
...
// since librdkafka v1.2.0
const RD_KAFKA_THREAD_MAIN = 0;
const RD_KAFKA_THREAD_BACKGROUND = 1;
const RD_KAFKA_THREAD_BROKER = 2;

// since librdkafka v1.2.1

// since librdkafka v1.2.2

// since librdkafka v1.3.0
